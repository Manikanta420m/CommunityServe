...
const getIssues = async (req, res) => {
  try {
    ...
    let issues = await Issue.find(buildIssueFilter(req.query)).populate("createdBy", "name email");
...
const updateIssue = async (req, res) => {
  try {
    ...
    const { title, description, category, location, priority, status, images, coordinates, statusNote } = req.body;
